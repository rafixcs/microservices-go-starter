...
type CreateTripRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RideFare      string                 `protobuf:"bytes,1,opt,name=rideFare,proto3" json:"rideFare,omitempty"`
	UserID        string                 `protobuf:"bytes,2,opt,name=userID,proto3" json:"userID,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateTripRequest) GetRideFare() string {
	if x != nil {
		return x.RideFare
	}
	return ""
...
type Trip struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	SelectedFare  string                 `protobuf:"bytes,2,opt,name=selectedFare,proto3" json:"selectedFare,omitempty"`
...
func (x *Trip) GetSelectedFare() string {
	if x != nil {
...
const file_trip_proto_rawDesc = "" +
	...
	"\x11totalPriceInCents\x18\x04 \x01(\x01R\x11totalPriceInCents\"G\n" +
	"\x11CreateTripRequest\x12\x1a\n" +
	"\brideFare\x18\x01 \x01(\tR\brideFare\x12\x16\n" +
	...
	".trip.TripR\x04trip\"\xb7\x01\n" +
	"\x04Trip\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\"\n" +
	"\fselectedFare\x18\x02 \x01(\tR\fselectedFare\x12!\n" +
